...
hid_cat_2 = Dense(512, activation='relu')(vect_cat)
hid_cat_1 = Dense(256, activation='relu')(hid_cat_2)
hid_cat = Dense(64, activation='relu')(hid_cat_1)
out = Dense(2, activation='softmax')(hid_cat)
...
# train
rms = RMSprop()
model_gpu.compile(loss=losses.categorical_crossentropy, optimizer=rms, metrics=[accuracy])
